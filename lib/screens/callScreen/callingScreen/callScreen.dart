...
import 'package:college_project_doctor/constants/string.dart';
...
class CallScreen extends StatefulWidget {
  ...
  final Call call;
  CallScreen({Key key, this.call, this.role}) : super(key: key);
  @override
...
class _CallScreenState extends State<CallScreen> {
  ...
  void _addAgoraEventHandlers() {
    _engine.setEventHandler(RtcEngineEventHandler(
      ...
      userOffline: (uid, elapsed) {
        widget._callMethods.endCall(widget.call);
        setState(() {
  ...
  addPostFrameCallBack() {
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      widget._userProvider = Provider.of<UserProvider>(context, listen: false);
      widget.callStreamSubscription = widget._callMethods
          .callStream(Constants.uid)
          .listen((DocumentSnapshot ds) {
        switch (ds.data) {
          case null: //when snapshot is null ie call is hanged and docs are deleted
  ...
  void dispose() {
    ...
    super.dispose();
    widget.callStreamSubscription.cancel();
  }
